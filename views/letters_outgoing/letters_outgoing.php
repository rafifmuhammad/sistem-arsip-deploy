...
$letters = query("SELECT * FROM tb_surat_keluar 
  JOIN tb_kategori 
...
if (isset($_POST['rentang_tanggal'])) {
  ...
  $letters = query("SELECT * FROM tb_surat_keluar
    JOIN tb_kategori 
    ON tb_surat_keluar.id_kategori = tb_kategori.id_kategori
    WHERE tanggal_keluar BETWEEN '$tanggal_awal' 
    AND '$tanggal_akhir'");
}
...
if (isset($_POST['tolak'])) {
  if (rejectLetter($_POST) > 0) {
    $_SESSION['flash'] = [
      "icon" => "success",
      "title" => "Berhasil",
      "text" => "Surat keluar berhasil ditolak",
    ];
  } else {
    $_SESSION['flash'] = [
      "icon" => "error",
      "title" => "Gagal",
      "text" => "Surat keluar gagal ditolak",
    ];
  }
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Arsipan - Surat Keluar Sistem Arsip</title>
    <meta
      name="viewport"
                    ...
                    <fieldset>
                      <div class="repeater-default">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-12">
                            <a
                              href="/sistem-arsip/outgoing/add/"
                              type="button"
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <button 
                          ...
                          data-toggle="modal"
                          data-target="#modalAlasan<?= $letter['id_surat_keluar']; ?>"
                        >
                        ...
                        <!-- Modal alasan -->
                        <div class="modal fade" id="modalAlasan<?= $letter['id_surat_keluar']; ?>" tabindex="-1">
                      ...
                      <td class="text-center">
                        <a href="/sistem-arsip/files/download/surat_keluar/<?= $letter['id_versi_aktif']; ?>/" class="text-primary">
                          <i class="mdi mdi-download"></i> Unduh
                        </a>
                      </td>
                      <td class="text-center">
                        <a
                          href="/sistem-arsip/outgoing/<?= $letter['id_surat_keluar']; ?>/"
                      ...
                      <td class="text-center">
                        <a
                          href="/sistem-arsip/outgoing/<?= $letter['id_surat_keluar']; ?>/edit/"
                      ...
                      <?php if ($letter['status'] !== 'arsip') : ?>
                      <td class="text-center">
                        <a href="#" class="btn btn-danger btn-sm tombol-hapus" data-href="/sistem-arsip/outgoing/<?= $letter['id_surat_keluar']; ?>/delete/"
                      ...
                      <td>
                        <div class="dropdown d-inline">
                          <a class="dropdown-toggle btn btn-outline-info btn-sm" data-toggle="dropdown">
                            Aksi
                          </a>
                          <div class="dropdown-menu">
                            <a class="dropdown-item text-info tombol-validasi" href="#" data-href="/sistem-arsip/letters/validate/surat_keluar/<?= $letter['id_surat_keluar']; ?>/">Validasi</a>
                            <div class="dropdown-divider"></div>
                            <?php if ($_SESSION['user']['role'] === 'kepala' && $letter['status'] !== 'draft' && empty($letter['alasan'])) : ?>
                            <a class="dropdown-item text-info tombol-setujui" href="#" data-href="/sistem-arsip/letters/approve/surat_keluar/<?= $letter['id_surat_keluar']; ?>/">Setujui</a>
                            <div class="dropdown-divider"></div>
                            <?php endif; ?>
                            <a 
                              class="dropdown-item text-info btn-tolak" 
                              href="#"
                              data-toggle="modal"
                              data-target="#modalTolak"
                              data-id="<?= $letter['id_surat_keluar']; ?>"
                              data-type="surat_keluar"
                            >Tolak</a
                            >
                          </div>
                        </div>
