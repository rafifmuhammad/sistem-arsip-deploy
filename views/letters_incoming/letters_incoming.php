                    ...
                    <fieldset>
                      <div class="repeater-default">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-12">
                            <a
                              href="/sistem-arsip/incoming/add/"
                              type="button"
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="/sistem-arsip/files/download/surat_masuk/<?= $letter['id_versi_aktif']; ?>/" class="text-primary">
                          <i class="mdi mdi-download"></i> Unduh
                        </a>
                      </td>
                      <td class="text-center">
                        <a
                          href="/sistem-arsip/incoming/<?= $letter['id_surat_masuk']; ?>/"
                      ...
                      <td class="text-center">
                        <a
                          href="/sistem-arsip/incoming/<?= $letter['id_surat_masuk']; ?>/edit/"
                      ...
                      <?php if ($letter['status'] !== 'arsip') : ?>
                      <td class="text-center">
                        <a href="#" class="btn btn-danger btn-sm tombol-hapus" data-href="/sistem-arsip/incoming/<?= $letter['id_surat_masuk']; ?>/delete/"
                      ...
                      <td>
                        <div class="dropdown d-inline">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item text-info tombol-validasi" href="#" data-href="/sistem-arsip/letters/validate/surat_masuk/<?= $letter['id_surat_masuk']; ?>/">Validasi</a>
                            <div class="dropdown-divider"></div>
                            <?php if ($_SESSION['user']['role'] === 'kepala' && $letter['status'] !== 'draft' && empty($letter['alasan'])) : ?>
                            <a class="dropdown-item text-info tombol-setujui" href="#" data-href="/sistem-arsip/letters/approve/surat_masuk/<?= $letter['id_surat_masuk']; ?>/">Setujui</a>
                            <div class="dropdown-divider"></div>
                            <?php endif; ?>
                            <a 
