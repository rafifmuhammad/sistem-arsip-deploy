...
$letter = query("SELECT * FROM tb_surat_masuk WHERE id_surat_masuk = '$id_surat_masuk'")[0];
$letter_versions = query(" SELECT * FROM tb_user 
                    JOIN tb_surat_masuk_versi 
                        ON tb_user.id_user = tb_surat_masuk_versi.id_user
                    JOIN tb_surat_masuk 
                        ON tb_surat_masuk.id_surat_masuk = tb_surat_masuk_versi.id_surat_masuk
                    WHERE tb_surat_masuk.id_surat_masuk = '$id_surat_masuk'");

// Tambah versi baru
if (isset($_POST['tambah'])) {
  $resultMeta = updateIncomingLetter($letter['id_surat_masuk'], $_POST);
  $resultVersion = addNewIncomingLetterVersion(
    $letter['id_surat_masuk'], 
    $_FILES['file'], 
    '69e55e13c41bb'
  );
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Arsipan - Perubahan Surat Masuk Sistem Arsip</title>
    <meta
      name="viewport"
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="page-title-box">
              <div class="row">
                <div class="col">
                  <h4 class="page-title">Perubahan Surat Masuk</h4>
                  <ol class="breadcrumb">
                    <!-- An Unactive Breadcrumb -->
                    <li class="breadcrumb-item">
                      <a href="./letters_incoming.php">Surat Masuk</a>
                    </li>
              ...
              <div class="card mt-2">
                <div class="card-header">
                  <h4 class="card-title">Riwayat Versi Surat Masuk</h4>
                </div>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $version['perihal_surat']; ?></td>
                        <td><?= $version['nama']; ?></td>
                        <td class="text-center"><?= $version['tanggal_terima']; ?></td>
                        ...
                        <td class="text-center">
                          <a
                            ...
                            data-href="./letters_apply_version.php?id_surat_masuk=<?= $letter['id_surat_masuk']; ?>&id_versi=<?= $version['id_versi']; ?>&type=<?= 'surat_masuk'; ?>"
                            ><i class="mdi mdi-eye"></i> Terapkan</a
                          >
                        </td>
                      </tr>
                      <?php endforeach; ?>
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Perubahan Surat Masuk</h4>
                </div>
                <!--end card-header-->
