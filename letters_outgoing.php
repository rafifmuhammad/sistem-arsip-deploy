                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="./download.php?id_versi=<?= $letter['id_versi_aktif']; ?>&type=<?= 'surat_keluar'; ?>" class="text-primary">
                          <i class="mdi mdi-download"></i> Unduh
                        </a>
                      </td>
                      <td class="text-center">
                        <a
                          href="./letters_detail.php?id_surat_keluar=<?= $letter['id_surat_keluar']; ?>&type=<?= 'surat_keluar'; ?>"
                      ...
                      <td class="text-center">
                        <a
                          href="./letters_edit_outgoing.php?id_surat_keluar=<?= $letter['id_surat_keluar']; ?>"
                      ...
                      <?php if ($letter['status'] !== 'arsip') : ?>
                      <td class="text-center">
                        <a href="#" class="btn btn-danger btn-sm tombol-hapus" data-href="letters_delete_outgoing.php?id_surat_keluar=<?= $letter['id_surat_keluar']; ?>"
                      ...
                      <td>
                        <div class="dropdown d-inline">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item text-primary tombol-validasi" href="#" data-href="letters_validation.php?id_surat_keluar=<?= $letter['id_surat_keluar']; ?>&type=<?= 'surat_keluar'; ?>">Validasi</a>
                            <a class="dropdown-item text-success" href="./letters_approve.php?id_surat_keluar=<?= $letter['id_surat_keluar']; ?>&type=surat_keluar">Setujui</a>
                            <a 
