...
if (isset($_POST['cetak'])) {
  ...
  header("Location: archives_report.php?tanggal_awal=$tanggal_awal&tanggal_akhir=$tanggal_akhir");
  exit;
}
?>
<!doctype html>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="./download.php?id_versi=<?= $archive['id_versi_aktif']; ?>&type=<?= $archive['type'] == 'masuk' ? 'surat_masuk' : 'surat_keluar'; ?>" class="text-primary">
                          <i class="mdi mdi-download"></i> Unduh
                        </a>
                      </td>
                      <td class="text-center">
                        <a
                          href="./letters_detail.php?<?= $archive['type'] == 'masuk' ? 'id_surat_masuk=' . $archive['id_surat'] : 'id_surat_keluar=' . $archive['id_surat']; ?>&type=<?= $archive['type'] == 'masuk' ? 'surat_masuk' : 'surat_keluar'; ?>"
